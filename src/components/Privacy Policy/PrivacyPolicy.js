...
export default function PrivacyPolicy() {
  return (
    <>
      <div className='sm:mx-5 md:mx-24 p-5'>
        <div>
          <h1 className='text-[50px] my-5 text-red-500 sm:text-center md:text-left' style={{ fontFamily: "'Merriweather', serif" }}>
            Privacy Policy<br /> Of JEC
          </h1>
        </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <p className='text-lg leading-7'>
                At JEc, we are dedicated to protecting your privacy. We collect personal information directly from you and through cookies for service improvement, transaction processing, and communication purposes. Your information is used to enhance our services, respond to inquiries, and provide updates and promotions. We do not sell your personal information and only share it with trusted partners as necessary to deliver our services. We implement robust security measures to safeguard your data against unauthorized access and breaches.
              </p>
            </div>
            <div className="col-md-6 flex items-center justify-end">
              <img src={privacy} alt="JEC Facilities" className='w-full max-w-sm' />
            </div>
          </div>
        </div>

        <div className='my-20 text-lg' style={{ fontFamily: "'Merriweather', serif" }}>
          <p>
        ...
        <div className='my-20 text-lg' style={{ fontFamily: "'Merriweather', serif" }}>
          <h1 className='text-5xl mb-3'>LICENSE</h1>
          <p>
          ...
          <h1 className='text-5xl my-5'>Hyperlinking to our Content</h1>
          <p>
          ...
          <h1 className='text-5xl my-5'>iFrames</h1>
          <p>
            Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.
          </p>

          <h1 className='text-5xl my-5'>Content Liability</h1>
          <p>
            We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that are rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene, or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.
          </p>

          <h1 className='text-5xl my-5'>Reservation of Rights</h1>
          <p>
            We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amend these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
          </p>

          <h1 className='text-5xl my-5'>Removal of links from our website</h1>
          <p>
          ...
          <h1 className='text-5xl my-5'>Disclaimer</h1>
          <p>
