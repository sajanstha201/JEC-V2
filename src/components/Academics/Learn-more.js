...
import people from '../../media/images/people.png';
import clock from '../../media/images/clock.png';
import report from '../../media/images/report.png';
...
export default function Learnmore() {
  return (
   ...
   <div className=' flex text-center items-center justify-center mt-5 '>
    ...
    <h1 className='text-[50px] font-bold text-center'>COURSE <span className='text-blue-500'>NAME</span></h1>
   </div>
   </div>

   <div className='ms-9 mt-9'>
    <h1 className='text-[40px] font-bold '>COURSE <span className='text-blue-500'>DESCRIPTION</span></h1>
   </div>
   <div className='h-[400px] flex items-center justify-center'>
           <h1>Course description</h1>
   </div>

   <h1 className='text-[40px] font-bold text-center my-4'>COURSE <span className='text-blue-500'>FEATURES</span></h1>
   ...
   <div className='container font-bold text-[20px]'>
    <div className='row'>
      ...
      <img
                className="card-img-top rounded-2xl w-[120px]"
                src={people}
                alt="people"
                
            />
                  <h1 className='text-[30px] font-bold text-center'>AVAILABLE <span className='text-blue-500'>SEATS</span></h1>
                  <h1 className='text-[30px] mt-3'>0</h1>
      </div>

      <div className=' col-12 col-md-4 col-sm-12 col-xs-12 flex flex-col items-center justify-center '>
      <img
                className="card-img-top rounded-2xl w-[100px]"
                src={clock}
                alt="people"
                
            />
                  <h1 className='text-[30px] font-bold text-center mt-3 text-blue-500'>DURATION</h1>
      ...
      <img
            ...
            />
                   <h1 className='text-[30px] font-bold text-center mt-3'>MIN <span className='text-blue-500'>QUILIFICATION</span></h1>
  ...
  INTROD<span className="text-blue-500">UCTION</span>
</h1>
   </div>
   <div className='h-[400px] flex items-center justify-center'>
   ...
   <h1 className='text-[40px] font-bold text-center mb-6'>COURSE <span className='text-blue-500'>BENEFITS</span></h1>
   ...
   <div className='ms-9 mt-20 text-center mb-6'>
    <h1 className='text-[40px] font-bold '>COURSE <span className='text-blue-500'>STRUCTURE</span></h1>
   </div>
    ...
    <div className='row '>
      <div className='col-12 col-md-6 col-sm-12 col-xs-12'>
        <div className='h-[60px] bg-blue-500 flex items-center justify-center mb-4'>
          <h1 className='text-[30px] font-bold text-center text-white '> FIRST YEAR
            </h1>
        </div>
        <div className='row'>
              <div className='col-12 col-md-6 col-sm-12 col-xs-12' >
       ...
       <div className='col-12 col-md-6 col-sm-12 col-xs-12'>
        <div className='h-[60px] bg-blue-500 flex items-center justify-center mb-4'>
          <h1 className='text-[30px] font-bold text-center text-white '> SECOND YEAR
            </h1>
        </div>
        <div className='row'>
              <div className='col-12 col-md-6 col-sm-12 col-xs-12' >
   ...
   <div className='text-center my-9 text-[30px] text-white font-bold'>
   <Link to={'/admission'}>
    <a className='border-solid border-2 border-white p-2 rounded-xl bg-blue-500 hover:bg-green-500 hover:text-white'>ENTRY-REQUIREMENTS </a>
  </Link>
   </div>
